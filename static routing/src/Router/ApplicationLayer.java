...
public class ApplicationLayer extends JFrame {
      ...
      public void actionPerformed(ActionEvent e) {
         ...
         if (e.getSource() == myAddressSet_btn) {
        	if(Mac_address.getText().length() == 0){
         		JOptionPane.showMessageDialog(null, "Address 1�� Mac �ּҸ� �������ּ���.", "WARNING_MESSAGE",
 						JOptionPane.WARNING_MESSAGE);
         	} else if (MyIPaddress.getText().length() < 12){
         		JOptionPane.showMessageDialog(null, "Address 1�� IP �ּҸ� 12�ڸ� �Է����ּ���.", "WARNING_MESSAGE",
 						JOptionPane.WARNING_MESSAGE);
         	} else {
	            System.out.println("Address 1 : [" + adapterNumber + "] �غ� �Ϸ�!");
	            for(int i = 0; i < 4; i++){
        	...
        	if(Mac_address2.getText().length() == 0){
        		JOptionPane.showMessageDialog(null, "Address 2�� Mac �ּҸ� �������ּ���.", "WARNING_MESSAGE",
						JOptionPane.WARNING_MESSAGE);
        	} else if (MyIPaddress2.getText().length() < 12){
        		JOptionPane.showMessageDialog(null, "Address 2�� IP �ּҸ� 12�ڸ� �Է����ּ���.", "WARNING_MESSAGE",
						JOptionPane.WARNING_MESSAGE);
        	} else {
	            System.out.println("Address 2 : [" + adapterNumber2 + "] �غ� �Ϸ�!");
		    	for(int i = 0; i < 4; i++){
        	...
        	if(Destination.getText().length() < 12) {
				JOptionPane.showMessageDialog(null, "12�ڸ� Destination IP �ּҸ� �Է����ּ���.", "WARNING_MESSAGE",
							JOptionPane.WARNING_MESSAGE);
			} else if(Netmask.getText().length() < 12) {
				JOptionPane.showMessageDialog(null, "12�ڸ� Netmask IP �ּҸ� �Է����ּ���.", "WARNING_MESSAGE",
							JOptionPane.WARNING_MESSAGE);
			} else if(Gateway.getText().length() < 12) {
				JOptionPane.showMessageDialog(null, "12�ڸ� Gateway IP �ּҸ� �Է����ּ���.", "WARNING_MESSAGE",
							JOptionPane.WARNING_MESSAGE);
			} else if(!CheckBoxUp.isSelected() && !CheckBoxGateway.isSelected() && !CheckBoxHost.isSelected()){
				JOptionPane.showMessageDialog(null, "Flag�� �������ּ���.", "WARNING_MESSAGE",
						JOptionPane.WARNING_MESSAGE);
			} else if(CheckBoxGateway.isSelected() && CheckBoxHost.isSelected()){
				JOptionPane.showMessageDialog(null, "Flag���� Gateway�� Host�� ���ÿ� ������ �� �����ϴ�.", "WARNING_MESSAGE",
						JOptionPane.WARNING_MESSAGE);
			} else if(interface_box.getText().length() < 1){
				JOptionPane.showMessageDialog(null, "Interface �̸��� �Է����ּ���.", "WARNING_MESSAGE",
						JOptionPane.WARNING_MESSAGE);
			} else {
        	...
        	if(routingIndex > 0){
				...
				if (ProxyARPDevice.getText().length() < 1 && ProxyARPIP.getText().length() < 12
					...
					JOptionPane.showMessageDialog(null, "Proxy ARP Entry�� ������ �Է����ּ���.", "WARNING_MESSAGE",
							JOptionPane.WARNING_MESSAGE);
				} else if (ProxyARPDevice.getText().length() < 1) {
					JOptionPane.showMessageDialog(null, "Proxy ARP Entry�� Device Name�� �Է����ּ���.", "WARNING_MESSAGE",
							JOptionPane.WARNING_MESSAGE);
				} else if (ProxyARPIP.getText().length() < 12) {
					JOptionPane.showMessageDialog(null, "Proxy ARP Entry�� IP �ּҸ� 12�ڸ� �Է����ּ���.", "WARNING_MESSAGE",
							JOptionPane.WARNING_MESSAGE);
				} else if (ProxyARPMac.getText().length() < 12) {
					JOptionPane.showMessageDialog(null, "Proxy ARP Entry�� MAC �ּҸ� 12�ڸ� �Է����ּ���.", "WARNING_MESSAGE",
							JOptionPane.WARNING_MESSAGE);
				} else {
   ...
   public String get_MacAddress(byte[] byte_MacAddress) {
      ...
      System.out.println("1�� ���� ���õ� �ּ�" + MacAddress);
   ...
   public String get_MacAddress2(byte[] byte_MacAddress) {
      ...
      System.out.println("2�� ���� ���õ� �ּ�" + MacAddress);
   ...
   public ApplicationLayer() {
      ...
      Label label_5 = new Label("MAC_�ּ�");
